...
public class ProductSizeServiceImpl extends BaseServiceImpl<ProductSize, ProductSizeRepository, ProductSizeDTO, ProductSizeMapper> implements ProductSizeService {
    public ProductSizeServiceImpl(ProductSizeRepository rep, ProductSizeMapper mapper, CategoryService categoryService, FileService fileService, ProductService productService, SizeService sizeService) {
        super(rep, mapper);
    ...
    public String create(ProductCreateRequest request, Integer languageOrdinal) {
        ...
        if (request != null) {
            ...
            ProductDTO product = productService.findByName(request.getName());
            if(product == null) {
